...
// ── Payment logos — 50×30px ─────────────────────────────────────────────────
const PAYMENT_LOGOS = [
  { src: "/assets/images/payment/vnpay.svg",       alt: "VNPay" },
  { src: "/assets/images/payment/momo.svg",         alt: "MoMo" },
  { src: "/assets/images/payment/visa.svg",         alt: "Visa" },
  { src: "/assets/images/payment/mastercard.svg",   alt: "Mastercard" },
  { src: "/assets/images/payment/jcb.svg",          alt: "JCB" },
  { src: "/assets/images/payment/napas.svg",        alt: "Napas" },
  { src: "/assets/images/payment/zalopay.svg",      alt: "ZaloPay" },
  { src: "/assets/images/payment/shopee-pay.svg",   alt: "ShopeePay" },
];

// ── Shipping logos — 50×30px ─────────────────────────────────────────────────
const SHIPPING_LOGOS = [
  { src: "/assets/images/shipping/ghn.svg",          alt: "Giao Hàng Nhanh" },
  { src: "/assets/images/shipping/ghtk.svg",         alt: "Giao Hàng Tiết Kiệm" },
  { src: "/assets/images/shipping/viettel-post.svg", alt: "Viettel Post" },
  { src: "/assets/images/shipping/vnpost.svg",        alt: "VN Post" },
];
...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn("w-full bg-[#0a0a0a]", className)}>
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-[120px] py-[32px] lg:pt-[96px] lg:pb-[48px]">

        {/* ── MOBILE layout (< lg) ── */}
        <div className="flex flex-col gap-[24px] lg:hidden">
          {/* Row 1 — Logo + Social (centered, border-bottom) */}
          <div className="flex flex-col gap-[24px] items-center pb-[24px] border-b border-[#404040]">
            <div className="relative w-[153px] h-[46px]">
              <Image
          ...
          {/* Row 2 — Tổng đài + Về Gearvn/Chính sách (2 columns, border-bottom) */}
          <div className="flex items-start justify-between pb-[24px] border-b border-[#404040]">
            {/* Left: Tổng đài hỗ trợ */}
          ...
          {/* Row 3 — Thông tin + Thanh toán/Vận chuyển (2 columns) */}
          <div className="flex items-start justify-between">
            ...
            {/* Right: Thanh toán + Vận chuyển */}
            <div className="flex flex-col gap-[32px] shrink-0 w-[168px]">
              <div className="flex flex-col gap-[12px]">
                <h3 className="text-[16px] font-semibold text-white tracking-[-0.32px] leading-[20px]">
                  HỖ TRỢ THANH TOÁN
                </h3>
        ...
        {/* ── DESKTOP layout (>= lg) ── */}
        <div className="hidden lg:flex lg:items-start lg:justify-between gap-10 pb-[24px] border-b border-[#404040]">
          {/* Col 1 — Brand + Social */}
          ...
          <div className="flex flex-col gap-[32px] shrink-0 w-[212px]">
            <div className="flex flex-col gap-[12px]">
              <h3 className="text-[16px] font-semibold text-white tracking-[-0.32px] leading-[20px]">
                HỖ TRỢ THANH TOÁN
              </h3>
        ...
        {/* ── Bottom bar ──────────────────────────────────── */}
        <div className="flex flex-col items-center lg:flex-row lg:items-center lg:justify-between gap-[16px] lg:gap-3 pt-[32px] lg:py-[24px]">
          <p className="text-[12px] font-medium text-[#737373] leading-[16px] text-center lg:text-left">
